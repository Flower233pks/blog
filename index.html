...
<div id="wrapper">
    ...
    <section id="main">
        <header>
            <span class="avatar"><img src="images/avatar.png" height="130" width="130" alt="" /></span>
        ...
        <form method="post" action="#">
            <div class="field">
                <input type="Orchidany" name="Orchidany" id="2333" placeholder="Name" />
            </div>
            <div class="field">
                <input type="email" name="email" id="2333" placeholder="Email" />
            </div>
            <div class="field">
